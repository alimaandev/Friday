...
### ✨ v4 — "The Orb" में नया
- **🧘 Zen Mode** — न्यूनतम UI: एक मोनोक्रोम ऑर्ब + चैट; `⌘B` से पूरा डैशबोर्ड
- **🖥️ कंप्यूटर कंट्रोल** — ऐप खोलें, विंडो फ़ोकस करें, टाइप करें, क्लिक करें — हर क्रिया पहले आपकी पुष्टि मांगती है
- **🧩 प्लगइन मार्केटप्लेस** — सेटिंग्स से एक क्लिक में कम्युनिटी प्लगइन इंस्टॉल/हटाएँ
- **🛠 कस्टम टूल बिल्डर** — प्राकृतिक भाषा में टूल बनाएँ, कोड की ज़रूरत नहीं
- **📚 लोकल RAG** — दस्तावेज़ इन्जेस्ट + सिमेंटिक खोज
- **🧠 नॉलेज ग्राफ़** — एंटिटी/रिलेशन निष्कर्षण + सेशन कंटिन्यूटी
- **🚫 ब्लैकआउट मोड** — एक टॉगल में फ़ुल-लोकल प्राइवेसी (Ollama, नेटवर्क टूल ब्लॉक)
